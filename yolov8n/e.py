...
def video_to_frames(video_path, frames_dir, overwrite=False, every=1, chunk_size=1000):
    ...
    stride = 1
    total = int(total/6)
    frame_chunks = [[i*stride, i*stride+chunk_size] for i in range(0, total, chunk_size)]  # split the frames into chunk lists
...
if __name__ == '__main__':
    # test it
    video_to_frames(video_path='22.mp4', frames_dir='extracted_frames', overwrite=True, every=5, chunk_size=100)
